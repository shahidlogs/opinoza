...
const STARTER_QUESTIONS = [
  ...
  // Technology
  { title: "What's your primary smartphone brand?", type: "poll", category: "Science & Technology", pollOptions: ["Apple (iPhone)","Samsung","Google (Pixel)","OnePlus","Other"] },
  { title: "Do you use AI tools in your daily life?", type: "poll", category: "Science & Technology", pollOptions: ["Yes, regularly","Sometimes","Rarely","No, not yet"] },
  { title: "How many hours a day do you spend on your phone?", type: "poll", category: "Science & Technology", pollOptions: ["Less than 2 hours","2–4 hours","4–6 hours","More than 6 hours"] },
  { title: "Do you think AI will mostly help or harm humanity?", type: "poll", category: "Science & Technology", pollOptions: ["Mostly help","Mostly harm","Both equally","Too early to tell"] },
  { title: "Your most-used social media platform?", type: "poll", category: "Science & Technology", pollOptions: ["Instagram","TikTok","Twitter/X","YouTube","LinkedIn","Facebook"] },
  { title: "Dark mode or light mode?", type: "poll", category: "Science & Technology", pollOptions: ["Dark mode always","Light mode always","Depends on the time of day"] },
  { title: "How important is fast internet to your daily life?", type: "rating", category: "Science & Technology", pollOptions: null },
  { title: "Do you own a smart home device?", type: "poll", category: "Science & Technology", pollOptions: ["Yes, and I love it","Yes, but I barely use it","No, but I want one","No, not interested"] },
  { title: "What do you mainly use your laptop or PC for?", type: "poll", category: "Science & Technology", pollOptions: ["Work","Gaming","Creative projects","Browsing and streaming","All of the above"] },
  { title: "How often do you update your apps?", type: "poll", category: "Science & Technology", pollOptions: ["As soon as updates drop","Occasionally","Only when forced","Rarely"] },
  { title: "Do you back up your data regularly?", type: "poll", category: "Science & Technology", pollOptions: ["Yes, always","Sometimes","No, I should probably start"] },
  { title: "Rate your overall tech-savviness", type: "rating", category: "Science & Technology", pollOptions: null },
  { title: "Apps or websites — which do you prefer for services?", type: "poll", category: "Science & Technology", pollOptions: ["Apps all the way","Websites — no clutter","No preference"] },
  { title: "How concerned are you about your online privacy?", type: "rating", category: "Science & Technology", pollOptions: null },
  { title: "Does social media have more positive or negative impact?", type: "poll", category: "Science & Technology", pollOptions: ["Mostly positive","Mostly negative","Both — depends on how you use it"] },
  { title: "What type of content do you consume most online?", type: "poll", category: "Science & Technology", pollOptions: ["Short videos (Reels/TikTok)","Long-form YouTube","Articles and blogs","Podcasts","All of these"] },
  { title: "E-books or physical books?", type: "poll", category: "Science & Technology", pollOptions: ["E-books","Physical books","Both equally","I don't really read books"] },
  { title: "How often do you video call with friends or family?", type: "poll", category: "Science & Technology", pollOptions: ["Daily","A few times a week","Monthly","Rarely"] },
  { title: "Do you use a VPN?", type: "poll", category: "Science & Technology", pollOptions: ["Yes, always","Sometimes","No"] },
  { title: "Rate the overall impact of technology on your quality of life", type: "rating", category: "Science & Technology", pollOptions: null },
