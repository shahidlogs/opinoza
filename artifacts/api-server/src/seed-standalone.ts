...
const STARTER_QUESTIONS = [
  ...
  { title: "Which app do you use the most every day?", description: "Think about the app you'd be lost without.", type: "short_answer", category: "Science & Technology", pollOptions: null },
  { title: "Which smartphone brand do you prefer?", description: "If you had to pick just one brand for your next phone, which would it be?", type: "poll", category: "Science & Technology", pollOptions: ["Apple (iPhone)", "Samsung", "Xiaomi", "Google Pixel", "Huawei", "OnePlus", "Other"] },
  ...
  { title: "Android or iPhone — which team are you on?", description: "When it comes to smartphones, there are two camps. Which is yours?", type: "poll", category: "Science & Technology", pollOptions: ["Android 🤖", "iPhone 🍎", "I switch between both", "Neither / Other"] },
  ...
  { title: "Which social media platform do you enjoy most?", description: "The one you'd keep if you could only use a single platform.", type: "poll", category: "Science & Technology", pollOptions: ["Instagram", "TikTok", "YouTube", "X (Twitter)", "Facebook", "LinkedIn", "Snapchat", "Other"] },
  ...
  { title: "Rate your current mobile network provider", description: "Consider call quality, data speed, coverage, and customer support.", type: "rating", category: "Science & Technology", pollOptions: null },
  ...
  { title: "How satisfied are you with your home internet provider?", description: "Speed, reliability, customer support, and value for money.", type: "rating", category: "Science & Technology", pollOptions: null },
  ...
  { title: "Rate your most-used search engine (Google, Bing, etc.)", description: "Speed, accuracy, privacy, and overall quality of results.", type: "rating", category: "Science & Technology", pollOptions: null },
