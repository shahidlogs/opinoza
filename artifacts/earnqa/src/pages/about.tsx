        ...
        <div className="bg-card border border-card-border rounded-2xl p-6 sm:p-8 mb-6 shadow-sm">
          ...
          <div className="space-y-5">
            ...
            <FeatureRow
              ...
              body="Once your balance reaches $20 (2000¢), you can request a withdrawal via PayPal, bank transfer, or gift card. Requests are reviewed in the queue and processed as soon as possible."
            />
          </div>
        </div>
